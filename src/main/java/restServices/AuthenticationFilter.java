...
public class AuthenticationFilter implements javax.ws.rs.container.ContainerRequestFilter {
	...
	private String AUTHENTICATION_SCHEME = "Basic";
	private Response ACCESS_DENIED = Response.status(Response.Status.UNAUTHORIZED)
			.entity("You cannot access this resource").build();
	private Response ACCESS_FORBIDDEN = Response.status(Response.Status.FORBIDDEN)
